...
Reverts EOD option block. Options have TTE=6 on Day 2 of the round — they do
not expire within a single competition day and the platform marks them at
current book price, not intrinsic settlement value. Writing naked short calls
with TTE>0 and no hedge loses money.

Active blocks:
  A. HYDROGEL_PACK — trend-aware fair (slow+fast EMA, +$22k vs v1.3)
  B. VELVETFRUIT_EXTRACT — v1.3 passive MM unchanged
  C. VEV_5300/5400/5500 — passive options MM, fair = exact book mid, cap=50
  D. Lottery — VEV_6000/6500 bid at 0 up to 300 units
"""
...
# =============================================================================
# Block C — Options passive MM (fair = exact book mid, no EMA drift)
# =============================================================================
OPT_DIS_E   = 0
OPT_JOIN_E  = 2
OPT_DEF_E   = 1
...
class Trader:
    ...
    def run(self, state: TradingState) -> Tuple[Dict[Symbol, List[Order]], int, str]:
        ...
        # ============================================================
        # Block C: Liquid options passive MM
        # fair = exact book mid each tick to avoid EMA drift bugs
        # ============================================================
