...
# =============================================================================
DAY_PERIOD       = 100_000
EOD_WINDOW       = 95_000    # ticks 95000-99900 within each day = last 50 of 1000 ticks

# Always-worthless options: VEV always ends below 5300 (historical: 5244/5266/5296)
EOD_OTM_SYMS     = ("VEV_5300", "VEV_5400", "VEV_5500")

# Near-ATM: sell only VEV_5200 — overpriced by 17-54 vs settlement across all 3 days.
# VEV_5100 removed: on upward-VEV days intrinsic can exceed market price, buffer insufficient.
EOD_NEAR_ATM     = {"VEV_5200": 5200}
